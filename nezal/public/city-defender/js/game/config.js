var Config = {
	...
	waves : [
		...
		{ creeps : [
			...
			{category : Plane, count : 1, values : {hp:1200, speed:8, power:3, rate:0.1, price: 4, range: 3} }
		] },
		{ creeps : [
		...
		{ creeps : [
			{category : BlackTank, count : 10, values : {hp:480, speed:8, power:2, rate:0.1, price: 3, range: 2} },
